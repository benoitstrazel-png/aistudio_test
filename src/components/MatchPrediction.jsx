        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="glass-card" style={{ borderLeft: '4px solid var(--accent-color)' }}>
                ...
                <div className="flex justify-between items-center mb-4">
                    <span>Confiance :</span>
                    <span style={{ color: (prediction.confidence || 0) >= 80 ? 'var(--success-color)' : (prediction.confidence || 0) >= 60 ? 'var(--warning-color)' : 'var(--danger-color)' }}>
                ...
                <div className="bg-slate-800 p-3 rounded">
                    ...
                    <p className="font-bold text-lg text-accent mt-1">{prediction.advice || 'Analyse en cours...'}</p>
                </div>
            </div>
        </div>
    );
